...
function savesListToTable(saveslist)
{
    ...
    if (saveslist == '') {
        $('<tr><td colspan="8">No saves yet. Create your first one by viewing a session\'s details and selecting one of the save options.</td></tr>').appendTo('#savesListtbody') }
    $.each(saveslist, function (i, v) {
