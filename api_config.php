...
$GLOBALS['api_config'] = array(
    ...
    "database" => array_merge($connectionConfig, [
        ...
        "multisession_create_user" => $_ENV['DATABASE_CREATOR_USER'] ?: $_ENV['DATABASE_USER'] ?:
                DatabaseDefaults::DEFAULT_DATABASE_CREATOR_USER,
        "multisession_create_password" =>
            $_ENV['DATABASE_CREATOR_PASSWORD'] ?: $_ENV['DATABASE_PASSWORD'] ?:
                DatabaseDefaults::DEFAULT_DATABASE_CREATOR_PASSWORD
    ]),
    "wiki" => array(
