...
$GLOBALS['api_config'] = array(
    ...
    "database" => array_merge($connectionConfig, [
        ...
        "multisession_create_user" => ($_ENV['DATABASE_CREATOR_USER'] ?? null) ?:
                ($_ENV['DATABASE_USER'] ?? null) ?: DatabaseDefaults::DEFAULT_DATABASE_CREATOR_USER,
        "multisession_create_password" =>
            ($_ENV['DATABASE_CREATOR_PASSWORD'] ?? null) ?:
                ($_ENV['DATABASE_PASSWORD'] ?? null) ?: DatabaseDefaults::DEFAULT_DATABASE_CREATOR_PASSWORD
    ]),
    "wiki" => array(
