...
final class Version20221114201818 extends MSPMigration
{
    ...
    protected function onUp(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, token text NOT NULL, refresh_token text NOT NULL, refresh_token_expiration datetime NOT NULL, pin VARCHAR(255) DEFAULT NULL, account_owner SMALLINT DEFAULT 0 NOT NULL, account_id INT DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
