...
final class Version20240518214710 extends MSPMigration
{
    ...
    protected function onUp(Schema $schema): void
    {
        ...
        $this->addSql(
            ...
            ALTER TABLE `plan_policy` ADD CONSTRAINT `fk_plan_policy_plan_id` FOREIGN KEY (`plan_id`) REFERENCES `plan` (`plan_id`) ON DELETE CASCADE;
            ALTER TABLE `plan_policy` ADD CONSTRAINT `fk_plan_policy_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `policy` (`id`) ON DELETE CASCADE;
            ALTER TABLE `policy` ADD CONSTRAINT `fk_policy_type_id` FOREIGN KEY (`type_id`) REFERENCES `policy_type` (`id`) ON DELETE CASCADE;
            ALTER TABLE `policy_layer` ADD CONSTRAINT `fk_policy_layer_policy_id` FOREIGN KEY (`policy_id`) REFERENCES `policy` (`id`) ON DELETE CASCADE;
            ALTER TABLE `policy_layer` ADD CONSTRAINT `fk_policy_layer_layer_id` FOREIGN KEY (`layer_id`) REFERENCES `layer` (`layer_id`) ON DELETE CASCADE;
            ALTER TABLE `policy_type_filter_type` ADD CONSTRAINT `fk_policy_type_filter_type_policy_type_id` FOREIGN KEY (`policy_type_id`) REFERENCES `policy_type` (`id`) ON DELETE CASCADE;
            ALTER TABLE `policy_type_filter_type` ADD CONSTRAINT `fk_policy_type_filter_type_policy_filter_type_id` FOREIGN KEY (`policy_filter_type_id`) REFERENCES `policy_filter_type` (`id`) ON DELETE CASCADE
            SQL
        );
        ...
        $this->addSql(
            ...
            ALTER TABLE `plan_layer` DROP FOREIGN KEY `plan_layer_ibfk_1`, ADD CONSTRAINT `fk_plan_player_plan_layer_plan_id` FOREIGN KEY (`plan_layer_plan_id`) REFERENCES `plan` (`plan_id`) ON DELETE CASCADE;
            ALTER TABLE `plan_message` DROP FOREIGN KEY `plan_message_ibfk_1`, ADD CONSTRAINT `fk_plan_message_plan_message_plan_id` FOREIGN KEY (`plan_message_plan_id`) REFERENCES `plan` (`plan_id`) ON DELETE CASCADE
            SQL
        );
