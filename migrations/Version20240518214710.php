...
final class Version20240518214710 extends MSPMigration
{
    ...
    protected function onUp(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ...
            CREATE TABLE `policy` (`id` INT AUTO_INCREMENT NOT NULL, `type` enum('energy','fishing','shipping','buffer_zone','seasonal_closure','eco_gear','sand_extraction') NOT NULL DEFAULT 'seasonal_closure', `data` JSON DEFAULT NULL COMMENT '(DC2Type:json)', INDEX `idx_policy_type` (`type`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;
